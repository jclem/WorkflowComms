defmodule SlackActionsWeb.SecureCompare do
  @moduledoc """
  ...
  Perform a constant-time comparison on two strings.
      ...
      iex> SlackActionsWeb.SecureCompare.secure_compare("foo", "")
      false

      iex> SlackActionsWeb.SecureCompare.secure_compare("foo", "bar")
      false

      iex> SlackActionsWeb.SecureCompare.secure_compare("foo", "foo")
      true
  """
